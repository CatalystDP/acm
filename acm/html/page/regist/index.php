...
<body>
    ...
    <div class="l-main-area sk-main-area center">
        <div class="v-marginfix"></div>
        <div class="l-form-wp sk-form-wp float-left">
            <form action="page/regist/submit.php" method="post">
                <div class="v-marginfix"></div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="phone" name="phone" class="l-input sk-input"/>
                    <p class="sk-input-status js-input-status"></p>
                </div>
                <div style="position: relative;">
                    ...
                    <div class="v-marginfix clearfix"></div>
                     <p class="sk-input-request">学校必须填写全名,
                        否则不给AC
                    </p>
                </div>
                <div class="v-marginfix clearfix"></div>
        ...
        <div class="l-uploadpic-wp float-left">
                <img src="img/defaultpic/defaultpic.gif" alt="未上传头像" class="l-registpic sk-personpic" />
             <p>图片尺寸不可以超过150*150</p>
             <form class="l-uploadpic-form position-relative" method="post" enctype="multipart/form-data" accept="image/*" encoding="multipart/form-data"  action="page/regist/ImageUpload.php" target="uploadiframe">
                <input type="button" class="l-upload-pic sk-upload-pic js-upload-pic display-block position-absolute" value="上传图片"/>
